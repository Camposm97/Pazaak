...
public class GameBoard extends StackPane {
	...
	public void buildBoard() {
		...
		HBox hBox1 = FXUtil.loadHBox(
				gm.getP1().getPlayerPane(Align.LEFT), s1, gm.getP2().getPlayerPane(Align.RIGHT));
		...
		HBox hBox2 = FXUtil.loadHBox(
				gm.getP1().getHandPane(Align.LEFT), s2, gm.getP2().getHandPane(Align.RIGHT));
		...
		HBox hBox3 = FXUtil.loadHBox(
				gm.getP1().getPlayField(), s3, gm.getP2().getPlayField());
		...
		root = new BorderPane(centerPane, 
				topPane, gm.getP1().getScoreBoard(), bottomPane, gm.getP2().getScoreBoard());
